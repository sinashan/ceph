...
public:
  ...
  int get_obj(const DoutPrefixProvider *dpp, rgw::sal::Object* obj, const get_obj_params& params, bool send, RGWRESTStreamRWRequest **req);
  ...
  int get_obj(const DoutPrefixProvider *dpp, const rgw_user& uid, req_info *info /* optional */, rgw::sal::Object* obj,
              const ceph::real_time *mod_ptr, const ceph::real_time *unmod_ptr,
              uint32_t mod_zone_id, uint64_t mod_pg_ver,
              bool prepend_metadata, bool get_op, bool rgwx_stat, bool sync_manifest,
              bool skip_decrypt, bool send, RGWHTTPStreamRWRequest::ReceiveCB *cb, RGWRESTStreamRWRequest **req);
